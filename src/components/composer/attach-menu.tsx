  ...
  return (
    <>
      ...
      <div className="absolute bottom-[52px] left-3 z-30 flex w-[min(80vw,246px)] flex-col gap-3 rounded-[20px] border border-[#ededed] bg-[#f1f1f1] p-4 text-[14px] leading-5 text-[#1b1b1b] shadow-[0_8px_28px_rgba(0,0,0,0.12)]">
        <p className="text-[12px] font-medium leading-4 text-[#1b1b1b]">
        ...
        <button
          type="button"
          className="flex w-full items-center justify-center gap-2 rounded-[10px] border border-[#ededed] bg-[#f7f7f7] px-4 py-2.5 text-[14px] font-semibold leading-5 text-[#1b1b1b] hover:bg-white"
        ...
        <button
          type="button"
          className="flex w-full items-center justify-center gap-2 rounded-[10px] border border-transparent bg-[#1b1b1b] px-4 py-2.5 text-[14px] font-semibold leading-5 text-white hover:opacity-90"
